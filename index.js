...
class Student extends Lambdasian {
	...
	graduate() {
		if (this.grade >= 70) {
			return `Congratulations, ${this.name}, you're grade of ${this.grade} qualifies you to graduate!`;
		} else {
			return `Sorry, because your score is ${this.grade}, you need more work. Try for a better grade!`;
		} //Stretch 3
	}
}
...
class ProjectManager extends Instructor {
	constructor(myObject) {
		super(myObject);
		this.gradClassName = myObject.gradClassName;
		this.favInstructor = myObject.favInstructor;
	}
	standUp(channel) {
